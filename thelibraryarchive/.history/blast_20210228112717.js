...
$(".home-page_1 h1").blast({
  delimiter: "character",
  tag: "span"
});

a = 0;
$(".home-page_1 .blast").each(function() {
  if (a == 300) {
    a = 400;
  }
  ...
  if (a == 400) {
    setTimeout(function() {
      $(".home-page_1 h1 img").addClass("animated rotateIn");
    }, 500);
  }
...
setTimeout(function() {
  $(".home-page_1 .blast").removeClass("animated bounceIn");
  $(".home-page_1 .blast").css("opacity", 1);

  $(".home-page_1 .blast").mouseenter(function() {
    var el = $(this);
...
setTimeout(function() {
  $(".home-page_1 .flat-button").addClass("animated bounceIn");
  $(
    ".home-page_1 .flat-button"
  ).one(
    "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend",
    function() {
      $(".home-page_1 .flat-button").removeClass("animated bounceIn");
      $(".home-page_1 .flat-button").css("opacity", 1);
    }
  );
}, 2000);

$(".home-page_1 .flat-button").mouseenter(function() {
  var el = $(this);
